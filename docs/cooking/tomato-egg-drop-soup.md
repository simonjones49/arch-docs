...
date: '17:56 26-07-2021'
taxonomy:
    tag:
        - cooking
        - egg
        - tomato
media_order: Tomato_egg_drop_soup.png
---
# Tomato Egg Drop Soup
<figure class="polaroid-box">
    <img alt="Tomato Egg Drop Soup" src="../../assets/images/Tomato_egg_drop_soup.png" title="Tomato Egg Drop Soup">
    <figcaption class="polaroid-caption">In China, egg drop soup is more than just egg and broth. </figcaption>
</figure>
